  ...
  return (
    <section className="w-full overflow-hidden">
      <div className="h-full relative">
        <div>
          <img className="w-full md:h-full h-96" src={aboutUsImg} alt="" />
        </div>
      ...
      <div className="border-b border-purple border-x py-5">
        <p className="first-letter:font-bold font-medium first-letter:text-4xl sm:w-[40%] w-72 text-2xl text-purple text-center mx-auto">
